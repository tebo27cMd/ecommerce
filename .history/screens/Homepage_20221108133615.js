import { StyleSheet, Text, View, SafeAreaView, ScrollView, Image, Link, TouchableOpacity } from 'react-native'
...
export default function Homepage({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.food}  onPress={() => navigation.navigate('  function renderProduct({item: product}) {
')}>
