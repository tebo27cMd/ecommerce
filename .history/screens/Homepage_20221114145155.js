...
export default function Homepage({navigation}) {
  return (
    <ImageBackground style={styles.container} source={bg} >
      ...
      <TouchableOpacity style={styles.food}  onPress={() => navigation.navigate('Productfood')}>
        <Image source={foodImage} style={{ width: '90%', height: '140px', alignSelf: 'center', borderRadius: '27px' }} />
          <View style={styles.typeText}>
          <Text style={{ alignSelf: 'center' ,fontWeight:'bold' }}>FOOD</Text>
          </View>
      ...
      <TouchableOpacity style={styles.drinks}  onPress={() => navigation.navigate('Products')}>
        ...
        <View style={styles.typeText}>
        <Text style={{ alignSelf: 'center', fontWeight:'bold'}}>Star</Text>
        </View>
      </TouchableOpacity>
