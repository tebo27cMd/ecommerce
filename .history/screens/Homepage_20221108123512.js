...
export default function Homepage() {
  return (
    <View style={styles.container}>
     ...
     <Text style={styles.bannerText}>choose from our Wholesome Meals  Refreshments</Text> 
     <Text style={styles.bannerText}>and</Text>
     <Text style={styles.bannerText}>Refreshments</Text>
      </View>
