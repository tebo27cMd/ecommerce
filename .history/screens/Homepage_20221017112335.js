...
import { SafeAreaView,View,ScrollView,StyleSheet,TextInput,Text } from "react-native";
...
export default function Homepage(){
    return(   
        <SafeAreaView  style={{flex: 1,backgroundColor: "cornflowerblue"}}>
            ...
            <View  style={{flex: 1, flexShrink: 1, flexBasis: 10, width: 700, height: 20, backgroundColor: "pink"}}><Text>flex: 1, flexShrink: 1, flexBasis: 10, width: 700, height: 20 (80px)>
