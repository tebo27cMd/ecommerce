  ...
  return (
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <View style={styles.container}>
        <View style={{ flex: 1 }}>
          <Image
            style={{ flex: 1, width: '100%',height:'80px', marginTop: -400, resizeMode: "contain" }}
            source={backgroundPicture}
          />
          <Image
            style={{ flex: 1, width: null,height:'80px', marginTop: -900, resizeMode: "contain" }}
        ...
        <View style={styles.bottomView}>
          ...
          <TouchableOpacity style={styles.registerLink} 
             ...
             title="register"
             onPress={() => navigation.navigate('register')}>
                <Text>Don't have a register</Text>
